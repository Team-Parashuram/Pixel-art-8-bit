...
/>`}
        ...
        <div className="mt-6 p-4 border-2 border-black bg-yellow-100 dark:bg-yellow-900/20">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li>
              Press{" "}
              <kbd className="px-2 py-1 bg-white dark:bg-black border-2 border-black">
                ↑
              </kbd>{" "}
              and{" "}
              <kbd className="px-2 py-1 bg-white dark:bg-black border-2 border-black">
            ...
            <li>
              Built-in commands: help, clear, echo, date, whoami, pwd, ls, about
            </li>
            <li>
              Add custom commands via the <code>commands</code> prop
            </li>
          </ul>
        </div>
      </section>
