...
const pixelSeparatorVariants = cva("shrink-0 bg-black dark:bg-[#ff8c00]", {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      variant: "double",
      className:
        "w-[3px] before:top-0 before:left-0 before:bottom-0 before:w-[1px] after:top-0 after:right-0 after:bottom-0 after:w-[1px]",
    },
    {
      orientation: "vertical",
      variant: "thick",
...
>(
  (
    { className, label, variant = "solid", separatorClassName, ...props },
    ref,
  ) => {
    return (
      <div
