    ...
    "@graph": [
      {
        ...
        "description": "Build nostalgic web experiences with Pixel UI - A complete 8-bit retro component library for React and Next.js. 50+ pixel-perfect components with TypeScript, Tailwind CSS, and Radix UI.",
        "publisher": {
          "@id": "https://pixel-art-8-bit.mishrashardendu22.is-a.dev/#organization"
        },
        "potentialAction": {
          "@type": "SearchAction",
          "target": {
            "@type": "EntryPoint",
            "urlTemplate": "https://pixel-art-8-bit.mishrashardendu22.is-a.dev/docs/components?q={search_term_string}"
          },
      ...
      },
      {
        ...
        "description": "8-Bit Retro Component Library for React and Next.js with 50+ pixel-perfect, accessible components",
        "operatingSystem": "Web Browser",
        "url": "https://pixel-art-8-bit.mishrashardendu22.is-a.dev/",
        "screenshot": "https://pixel-art-8-bit.mishrashardendu22.is-a.dev/og-image.png",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "USD"
        ...
        "keywords": "pixel art, 8-bit, retro UI, React components, Next.js, TypeScript, Tailwind CSS"
      },
      {
        "@type": "SoftwareSourceCode",
        "name": "Pixel UI",
        "description": "8-Bit Retro Component Library for React and Next.js - Open Source",
      ...
      },
      {
        ...
        "description": "Build nostalgic web experiences with pixel-perfect components inspired by classic 8-bit games. Free, open-source, and fully accessible.",
        "inLanguage": "en-US",
        "primaryImageOfPage": {
          "@type": "ImageObject",
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": "Forms",
            "description": "Pixel-perfect form components including buttons, inputs, and selects"
          },
          {
            "@type": "ListItem",
            "position": 2,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Navigation",
            "description": "Navigation components including tabs, menus, and breadcrumbs"
          },
          {
            "@type": "ListItem",
            "position": 4,
            "name": "Feedback",
            "description": "User feedback components like alerts, toasts, and progress bars"
          },
          {
            "@type": "ListItem",
            "position": 5,
